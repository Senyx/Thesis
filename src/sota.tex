...
\parbox[t]{2mm}{\multirow{4}{*}{\rotatebox[origin=c]{90}{Preceding}}}
	& Super Heavy & 4 NM         & 6 NM   & 7 NM    & 8 NM  \\
    & Heavy       & 4 NM         & 4 NM   & 5 NM    & 6 NM  \\
    & Medium      & 4 NM         & 4 NM   & 4 NM    & 5 NM  \\ 
    & Light       & 4 NM         & 4 NM   & 4 NM    & 4 NM  \\ \hline
\end{tabular}
  \caption{Wake separation minima \cite[Chapter 7]{aim}}
  \label{tab:wake_separation}
\end{table}

Table \ref{tab:wake_separation} shows the separation minima used for aircraft following behind another aircraft at the same altitude or less than 1000ft when both aircraft are using the same runway or parallel runways separated by less than 2500ft.
